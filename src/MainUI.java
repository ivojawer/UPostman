...
public class MainUI {
    public static void main(String[] args) throws SQLException {
        ...
        KeyValueDao<Header> headerDao = new KeyValueJDBCImplDao<>(connection,"value", "key", "Header", new HeaderMapper());
        KeyValueDao<Parameter> parameterDao = new KeyValueJDBCImplDao<>(connection,"value", "name", "Parameter", new ParameterMapper());
